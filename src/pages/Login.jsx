...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // App.jsx gatekeeper handles success state update & routing automatically.
    } catch (err) {
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-6 bg-gradient-to-br from-bg-primary via-bg-surface to-bg-primary">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-text-secondary text-center text-sm mb-10 font-medium">Enter your credentials to securely access the platform</p>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 text-center">
             <p className="text-sm text-text-secondary">
               Don't have an account? Signup now to experience the future of recruitment.
               <Link to="/signup" className="text-accent-primary font-bold ml-2 hover:text-white transition-colors underline-offset-4 hover:underline cursor-pointer">
                 Register Now
               </Link>
             </p>
          </div>
